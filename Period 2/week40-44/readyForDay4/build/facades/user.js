...
const bcryptjs_1 = require("bcryptjs"); // Only to simplify hashing of test data
const debug = require("debug")("facade-no-db");
...
// // Setup af few test users with same password
// bryptAsync("secret")
//   .then((p: string) => {
//     const users: Array<IGameUser> = [
//       { name: "Peter Pan", userName: "pp@b.dk", password: p, role: "user" },
//       { name: "Donald Duck", userName: "dd@b.dk", password: p, role: "user" },
//       { name: "admin", userName: "admin@a.dk", password: p, role: "admin" }
//     ]
//     //UserFacade.users = users;
//   })
class UserFacade {
    static addUser(user) {
...
UserFacade.users = [
    { name: "Peter Pan", userName: "pp@b.dk", password: bcryptjs_1.hashSync("secret", 10), role: "user" },
    { name: "Donald Duck", userName: "dd@b.dk", password: bcryptjs_1.hashSync("secret", 10), role: "user" },
    { name: "admin", userName: "admin@a.dk", password: bcryptjs_1.hashSync("secret", 10), role: "admin" }
];
function test() {
    return __awaiter(this, void 0, void 0, function* () {
        console.log("testing");
