...
if (process.env["USE_USER_DB_FACADE_FOR_AUTHENTICATION"]) {
    UserFacade = userFacadeWithDB_1.default;
}
else {
    UserFacade = user_1.default;
}
// Create server
var authMiddleware = function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (credentials && (yield UserFacade.checkUser(credentials.name, credentials.pass))) {
                const user = yield UserFacade.getUser(credentials.name);
